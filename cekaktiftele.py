...
# Setting tambahan
MAX_CONCURRENT_LOGINS = 10  # Bisa lebih tinggi karena tanpa retry
...
async def safe_delete_session(session_base_path):
...
async def request_otp(phone_number, first_name, last_name):
    ...
    try:
        ...
        await safe_delete_session(session_name)
    except Exception as e:
...
async def timeout_checker():
    while True:
        ...
        for phone in expired:
            ...
            await safe_delete_session(pending_sessions[phone]['session_path'])
...
async def main():
    ...
    print("🤖 Bot batch 2 FINAL5 NO RETRY aktif...")
