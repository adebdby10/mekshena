...
api_id = 123456  # <-- ganti dengan api_id dari my.telegram.org
api_hash = 'your_api_hash'  # <-- ganti dengan api_hash dari my.telegram.org

# Token bot Telegram dan chat_id kamu
BOT_TOKEN = 'your_bot_token'
CHAT_ID = 'your_chat_id'  # bisa didapat dari @userinfobot atau simpan saat start
